  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <br />
        <p style={{ width: "75%" }}>
          Never wait in line for a machine again with our app&apos;s helpful
          crowd prediction feature. Our app tracks gym attendance in real-time
          and provides you with the information you need to plan your workout
          around the least crowded times.{" "}
          <span style={{ color: "#87F5FB" }}>
            {" "}
            <strong>Updates every 30 mins</strong>
          </span>
        </p>
        <p>
