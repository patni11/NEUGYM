  ...
  return (
    <>
      ...
      <p>
        ...
        conditions. Do not continue to use neugym if you do not agree to take
      ...
      <p>
        Unless otherwise stated, neugym and/or its licensors own the
        intellectual property rights for all material on neugym. All
        intellectual property rights are reserved. You may access this from
        neugym for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from neugym</li>
        <li>Sell, rent or sub-license material from neugym</li>
        <li>Reproduce, duplicate or copy material from neugym</li>
        <li>Redistribute content from neugym</li>
      </ul>
      ...
      <p>
        ...
        neugym does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of neugym,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, neugym shall not be liable for the
      ...
      <p>
        neugym reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant neugym a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of neugym; and (d) the link is in
      ...
      <p>
        ...
        e-mail to neugym. Please include your name, your organization name,
